        ...
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-[#3b1a08] dark:text-white flex items-center gap-2">
              <Send className="h-8 w-8 text-[#D05A1E] animate-pulse" /> Kampanye Email Massal
            </h2>
            <p className="text-muted-foreground text-sm">
              Buat dan kirim promosi terarah ke ribuan kontak prospek PT VeloCocoa melalui integrasi Odoo mass.mailing.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="border-none shadow bg-white dark:bg-[#2A1D16] p-4 flex flex-row items-center gap-3">
              ...
              <div>
                ...
                <span className="text-lg font-black">{totalSent} Penerima</span>
              </div>
            </Card>
            <Card className="border-none shadow bg-white dark:bg-[#2A1D16] p-4 flex flex-row items-center gap-3">
        ...
        <Card className="border-none shadow-lg bg-white dark:bg-[#2A1D16] rounded-2xl overflow-hidden">
          <CardHeader className="pb-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <CardTitle className="text-xl font-bold text-[#3b1a08] dark:text-white">Daftar Kampanye Email</CardTitle>
            ...
            >
              <div className="flex items-center justify-between border-b border-border/30 pb-3">
                <h2 className="text-xl font-bold flex items-center gap-2 text-foreground">
                  <Send className="h-6 w-6 text-[#D05A1E]" /> Buat Kampanye Email Baru
                </h2>
                <Button 
                  type="button" 
                  variant="ghost" 
            ...
            <div className="bg-card w-full max-w-2xl p-6 rounded-2xl shadow-2xl border border-primary/20 space-y-4 text-left max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between border-b border-border/30 pb-3">
                <h2 className="text-lg font-bold flex items-center gap-2 text-foreground">
                  <FileText className="h-5 w-5 text-[#D05A1E]" /> Detail Kampanye
                </h2>
                <Button 
                  type="button" 
                  variant="ghost" 
